...
if( debug_enabled )
{
	draw_rectangle_color( 0,0, room_width, debug_height, c_black, c_black, c_black, c_black, false );
	draw_text_color( 2, 20, "Perlin iterations: " + string( iterations ), c_red, c_red, c_red, c_red, 1 );
	draw_text_color( 2, 35, "Cloud scale: " + string( scale ), c_red, c_red, c_red, c_red, 1 );
