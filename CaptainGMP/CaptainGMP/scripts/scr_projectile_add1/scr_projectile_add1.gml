/// @description scr_add_projectile( owner, type, x, y, v0, v1, dam, spr_pro, ttl, spr_end, snd_amb, snd_imp )
/// @param owner
/// @param type
/// @param x
/// @param y
...
with( global.projectile_manager )
{
	...
	ds_list_add( list_a_amb, argument10 );
	ds_list_add( list_a_amb, argument11 );
}
